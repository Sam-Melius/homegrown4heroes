...
export default function MedicalCardPage() {
  return <>
    ...
    <section className="section cannabis-partner-section"><div className="shell cannabis-partner-card">
      <div className="cannabismd-wordmark" aria-label="CannabisMD TeleMed"><span className="cannabismd-leaf" aria-hidden="true">✦</span><div><strong>CANNABIS<span>MD</span></strong><small>TeleMed</small></div></div>
