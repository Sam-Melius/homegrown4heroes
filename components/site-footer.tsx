  ...
  return (
    <footer className="site-footer">
      <div className="shell footer-grid">
        <div className="footer-brand"><Image src="/homegrown4heroes-logo.png" alt="Homegrown 4 Heroes" width={150} height={150} /><p>Helping veterans heal, grow, and build community through accessible plant-based wellness education.</p></div>
